package com.mitsko.financial_system.repository.connection_pool;

import com.mitsko.financial_system.config.PropertyManager;
import com.mitsko.financial_system.constant.DBConstants;
...
public class ConnectionPool {
    ...
    private ConnectionPool() {
        ...
        try {
            driverName = manager.getValue(DBConstants.DB_DRIVER);
            url = manager.getValue(DBConstants.DB_URL);
            user = manager.getValue(DBConstants.DB_USER);
            password = manager.getValue(DBConstants.DB_PASSWORD);
