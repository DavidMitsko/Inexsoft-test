...
public class ClientRepositoryConstants {
    ...
    public static final String CREATE_NEW_CLIENT = "INSERT INTO client(uuid, name, surname, age, client_type)" +
            " VALUES(?,?,?,?, ?)";
    public static final String GET_CLIENT_BY_UUID = "SELECT uuid, name, surname, age, client_type FROM client WHERE uuid = ?";
    ...
    public static final String GET_ALL = "SELECT uuid, name, surname, age, client_type FROM client";
